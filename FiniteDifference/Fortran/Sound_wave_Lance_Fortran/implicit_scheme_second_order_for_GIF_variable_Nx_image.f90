			...
			if (i==(Nt-1)*(1+k)/400) then				
				...
				if (Nt-1<10000) then
					if (i<10) then		
						...
						write(file_name,'(A,I4.1,A,I4.1,A,I5.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					endif

				else
					if (i<10) then		
				  		write(file_name,'(A,I4.1,A,I5.1,A,I1.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					else if (i<100) then
						write(file_name,'(A,I4.1,A,I5.1,A,I2.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					else if (i<1000) then
						write(file_name,'(A,I4.1,A,I5.1,A,I3.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					else if (i<10000) then
						write(file_name,'(A,I4.1,A,I5.1,A,I4.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					else if (i<100000) then
						write(file_name,'(A,I4.1,A,I5.1,A,I5.1,A)') "file_txt/P_Nx_",Nx_P,"_Nt_",Nt-1,"_img_",i,".txt"
					endif
